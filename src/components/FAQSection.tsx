...
const FAQSection = () => {
  ...
  return <section className="py-6 sm:py-10 md:py-14 bg-muted/30">
      <div className="container mx-auto px-3 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center mb-6 sm:mb-10">
          <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-2 sm:mb-3 md:text-2xl">
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-3 sm:space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-background rounded-lg border border-border px-3 sm:px-4">
