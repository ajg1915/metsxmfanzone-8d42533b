...
const LiveGameTicker = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-primary/90 via-primary to-primary/90 text-primary-foreground py-2 px-4 overflow-hidden my-6 sm:my-8 mx-4 sm:mx-6 lg:mx-8 rounded-xl">
